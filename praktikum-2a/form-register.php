  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nim" name="nim" placeholder="*0110124001" type="text" class="form-control" required="required" pattern="[0-9]{10}" tittle="NIM harus 10 Digit Angka">
        </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nama_lengkap" name="nama_lengkap" placeholder="*Ananda yufa" type="text" class="form-control" required="required" minlenght="3" maxlenght="50">
        </div>
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="email" name="email" placeholder="*anandayupa@gmail.com" type="text" class= "form-control" required="required">
      </div>
    </div>
  </div> 
  <div class="form-group row">
